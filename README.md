Github? Mikä se on ja miten sitä käytetään? Ja mihin sitä tarvitaan?!
...
Nyt muista, että tämä on Unityä varten tehty ohje, mutta varmasti muutkin muodot ovat samankaltaisia, jos katsot jonkun muun ohjeen eri aiheeseen.

Miten minä julkaisen teokseni?

Jos haluat julkaista projektin päivityksen tai ylipäätään julkaista projektin, mene GitHubiin ja klikkaa "Create new release".
